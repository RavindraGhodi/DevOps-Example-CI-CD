node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u Ravindraghodi007@gmail.com -p Hello@123" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 1662fd466d7e ravindraghodi/springboot" //must change your name and tag no
        sh "docker push   ravindraghodi/springboot"
  }
}
